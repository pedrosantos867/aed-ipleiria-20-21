...
public class MainPraticaGestorContactosOtimizadoContinuacao {
    ...
    public MainPraticaGestorContactosOtimizadoContinuacao() {
        ...
        System.out.println(GestorContactosOtimizado.INSTANCIA.consultar(numeroTelefone1));

        GestorContactosOtimizado.INSTANCIA.remover(numeroTelefone1);

        Data data1 = new Data(18, 3, 1994);

        System.out.println("Moradas da data: " + data1);
        for (String morada : GestorContactosOtimizado.INSTANCIA.consultarMoradas(data1)) {
        ...
        for (Contacto contacto : GestorContactosOtimizado.INSTANCIA.consultar(data1, morada1)) {
            System.out.println(contacto);
        }
